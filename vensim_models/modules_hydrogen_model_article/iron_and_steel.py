...
_integ_errorint_steel = Integ(
    lambda: k_i() * error_steel(), lambda: 0.03, "_integ_errorint_steel"
)
...
_integ_foundry_reinvestment = Integ(
    ...
    lambda: primary_sector() / foundry_lifetime() * 0.9,
    "_integ_foundry_reinvestment",
)
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"ngdri_cost": 1, "h2dri_cost": 3, "bf_ccs_cost": 1, "bf_coal_cost": 1},
)
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"h2dri_cost": 1, "ngdri_cost": 3, "bf_ccs_cost": 1, "bf_coal_cost": 1},
)
