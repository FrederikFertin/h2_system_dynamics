...
@component.add(name='"NH3/H2 0"', comp_type="Constant", comp_subtype="Normal")
def nh3h2_0():
    return 5.56
...
def electricity_price():
    ...
    €/MWH
    """
    return np.interp(time(), [2019.0, 2030.0, 2040.0, 2050.0], [0.4, 0.5, 0.47, 0.35])
...
@component.add(name='"H2 - ammonia ratio"', comp_type="Constant", comp_subtype="Normal")
...
@component.add(name='"NH3/H2 1"', comp_type="Constant", comp_subtype="Normal")
def nh3h2_1():
    return 5.56
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"electricity_price_1": 1, "electricity_taxes": 1},
)
def ownership_cost_bev_urban():
    return 35000 + electricity_price_1() * electricity_taxes() * 0.45 * 240000
...
def ownerhip_cost_bev_long_haul():
    return 390000 + electricity_price_1() * electricity_taxes() * 2.26 * 1200000.0
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"electricity_price_1": 1},
)
def opex_hydrogen():
    return electricity_price_1()
