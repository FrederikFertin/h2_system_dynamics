...
def blue_nh3_cost():
    return (
        nh3_cost_without_hydrogen_costs() + blue_h2_cost() / nh3_h2_usage() / nh3_lhv()
    )
...
def green_nh3_cost():
    return (
        nh3_cost_without_hydrogen_costs() + green_h2_cost() / nh3_h2_usage() / nh3_lhv()
    )
...
def grey_nh3_cost():
    return (
        nh3_cost_without_hydrogen_costs() + grey_h2_cost() / nh3_h2_usage() / nh3_lhv()
    )
